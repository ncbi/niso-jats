...
(Authoring (Pumpkin) Version DRAFT NISO JATS 1.2d1 July 2017)
...
This README describes:
   ...
   2.0 Modules Needed for each DTD
       2.1 Modules Used in Authoring XHTML MathML 2.0 DTD
       2.2 Modules Used in Authoring XHTML MathML 3.0 DTD
       2.3 JATS Base Modules (used by both the Authoring DTDs)
   3.0 Descriptions of All Modules
       3.1  Modules Specific to the Authoring DTDs
...
2.1 Modules Used in the Authoring XHTML MathML 2.0 DTD
...
2.2  Modules Used in the Authoring XHTML MathML 3.0 DTD
...
2.3 JATS Base Modules (used by all the Authoring DTDs)
...
2.3.3 NISO Access and Indicator Files
 - JATS-ali-namespace1.ent   

2.3.4 Notations and Special Characters
