...
Archiving Tag Set described in version 0.4 of NISO Z39.96 "JATS: 
...
jats-archiving-documentation-0.4.zip
	This file contains the HTML of the Tag Library for the version
	0.4 Archiving Tag Set. A copy of this documentation is available
	online at http://jats.nlm.nih.gov/archiving/tag-library/0.4/
		
jats-archiving-dtd-0.4.zip
	This file contains the version 0.4 Archiving Tag Set expressed 
	as a Document Type Definition (DTD). 
		
jats-archiving-rng-0.4.zip
	This file contains the version 0.4 Archiving Tag Set expressed 
	as a RELAX NG schema (RNG; see http://relaxng.org). 
		
jats-archiving-xsd-0.4.zip
	This file contains the version 0.4 Archiving Tag Set expressed 
